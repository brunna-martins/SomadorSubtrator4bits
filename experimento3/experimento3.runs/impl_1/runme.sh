...
HD_PWD='C:/Users/brunn/OneDrive/Documentos/UnBosta/PED_2022.2/experimento3/experimento3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soma_sub4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soma_sub4.tcl -notrace
